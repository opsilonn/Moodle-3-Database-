 ...
 * @author Hugues
 */
public class BEGEOT_BUNOUF_RechercheEtudiant extends BEGEOT_BUNOUF_Recherche
{
    /* GROUPE */
    ...
    public static float moyenneMinMax(int groupeID, boolean mode, int cours) {
        float returnValue = -1;
        ArrayList<Integer> matricules = BEGEOT_BUNOUF_RechercheEtudiant.eleveBelongingtoGroup(groupeID);
