...
import GUI_Components.ButtonEditor.BEGEOT_BUNOUF_ButtonEditorGroupe;
import GUI_Components.ButtonEditor.BEGEOT_BUNOUF_ButtonEditorProf;
...
public class BEGEOT_BUNOUF_GUI_Cours extends BEGEOT_BUNOUF_CustomJFrame {
     ...
     */
    public BEGEOT_BUNOUF_GUI_Cours(int newCours) {
    ...
    private void createUIComponents() {
        ...
        textAnnee = new BEGEOT_BUNOUF_CustomJTextField("NUMERIC", false, 4);
        textDE = new BEGEOT_BUNOUF_CustomJTextField("DECIMAL", false, 5);
        textTP = new BEGEOT_BUNOUF_CustomJTextField("DECIMAL", false, 5);
        textProjet = new BEGEOT_BUNOUF_CustomJTextField("DECIMAL", false, 5);
        textCoeff = new BEGEOT_BUNOUF_CustomJTextField("DECIMAL", false, 5);
    }

    /**
     * BEGEOT_BUNOUF_Recherche du cours avec le code rentré par l'utilisateur
     */
    ...
    public void displayProf() {
        ...
        try {
            ...
            if (totalRows > 0) {
                ...
                tableProf.getColumn(" X ").setCellRenderer(new BEGEOT_BUNOUF_ButtonRenderer());
                tableProf.getColumn(" X ").setCellEditor(new BEGEOT_BUNOUF_ButtonEditorProf(new JCheckBox(), this));
    ...
    public void displayGroup() {
        ...
        try {
            ...
            if (totalRows > 0) {
                ...
                tableGroupe.getColumn(" X ").setCellRenderer(new BEGEOT_BUNOUF_ButtonRenderer());
                tableGroupe.getColumn(" X ").setCellEditor(new BEGEOT_BUNOUF_ButtonEditorGroupe(new JCheckBox(), this));
    ...
    private void addProf() {
        ...
        new BEGEOT_BUNOUF_GUI_addProfGroupe_toCours(codeCours, this, true);
    }
    ...
    private void addGroupe() {
        this.setVisible(false);
        new BEGEOT_BUNOUF_GUI_addProfGroupe_toCours(codeCours, this, false);
    }
