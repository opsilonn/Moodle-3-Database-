 ...
 * @author Hugues
 */
class BEGEOT_BUNOUF_GUI_modifierNote extends BEGEOT_BUNOUF_CustomJFrame {
    ...
    public BEGEOT_BUNOUF_GUI_modifierNote(int matricule) {
        ...
        if (matricule == -1) {
            ...
            addWindowListener(new WindowAdapter() {
                ...
                public void windowClosing(WindowEvent e) {
                    new BEGEOT_BUNOUF_GUI_USER_Professeur(matricule);
                    dispose();
                }
            });
    ...
    private void createUIComponents() {
        fieldNote = new BEGEOT_BUNOUF_CustomJTextField("DECIMAL", false, 5);
    ...
    private void moveDate() {
        ...
        if (getRows(data) == 1) {
            try {
                textDate.setDate(BEGEOT_BUNOUF_DateFunctions.convertDate(data.getString("Date_exam")));
