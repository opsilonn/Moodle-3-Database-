...
public class BEGEOT_BUNOUF_GUI_USER_Admin extends BEGEOT_BUNOUF_CustomJFrame {
     ...
     */
    public BEGEOT_BUNOUF_GUI_USER_Admin() {
    ...
    private void modifNotes(){
        new BEGEOT_BUNOUF_GUI_modifierNote(-1);
        dispose();
    }
    ...
    private void action(String table, int choice) {
        if (!search) {
            ...
            new BEGEOT_BUNOUF_GUI_chercherPersonne(table, res);
        } else {
            new BEGEOT_BUNOUF_GUI_chercherPersonne(table, -1);
        }
        dispose();
    }
    ...
    private void cours() {
        if (!search) {
            ...
            new BEGEOT_BUNOUF_GUI_Cours(res);
        } else {
            new BEGEOT_BUNOUF_GUI_Cours(-1);
        }
        dispose();
    }
    ...
    private void groupe() {
        if (!search) {
            ...
            new BEGEOT_BUNOUF_GUI_Groupe(res);
        } else {
            new BEGEOT_BUNOUF_GUI_Groupe(-1);
        }
        dispose();
    }
