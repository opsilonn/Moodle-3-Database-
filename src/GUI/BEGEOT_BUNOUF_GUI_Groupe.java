...
import GUI_Components.ButtonEditor.BEGEOT_BUNOUF_ButtonEditorCours4Groupe;
import GUI_Components.ButtonEditor.BEGEOT_BUNOUF_ButtonEditorEleve;
...
import static GUI.BEGEOT_BUNOUF_GUI_USER_Admin.WindowClosing;

public class BEGEOT_BUNOUF_GUI_Groupe extends BEGEOT_BUNOUF_CustomJFrame {
    ...
    private BEGEOT_BUNOUF_ButtonEditorEleve buttonEdit;
     ...
     */
    public BEGEOT_BUNOUF_GUI_Groupe(int newGroupe) {
    ...
    public void displayCours() {
        ...
        try {
            ...
            if (totalRows > 0) {
                ...
                tableCours.getColumn(" X ").setCellEditor(new BEGEOT_BUNOUF_ButtonEditorCours4Groupe(new JCheckBox(), this));
    ...
    public void addCours() {
        ...
        new BEGEOT_BUNOUF_GUI_addCours(codeGroupe, null, this);
    }
    ...
    public void addEleve() {
        this.setVisible(false);
        new BEGEOT_BUNOUF_GUI_addEleve(codeGroupe, this, null);
    }
    ...
    public void displayEleves() {
        ...
        try {
            ...
            if (totalRows > 0) {
                ...
                tableEleve.getColumn(" X ").setCellRenderer(new BEGEOT_BUNOUF_ButtonRenderer());

                buttonEdit = new BEGEOT_BUNOUF_ButtonEditorEleve(new JCheckBox(), this);
