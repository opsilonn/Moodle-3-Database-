...
public class BEGEOT_BUNOUF_GUI_addProfGroupe_toCours extends BEGEOT_BUNOUF_CustomJFrame {
     ...
     */
    public BEGEOT_BUNOUF_GUI_addProfGroupe_toCours(int code, BEGEOT_BUNOUF_GUI_Cours gui, boolean mode) {
