 ...
 * @author Hugues
 */
public class BEGEOT_BUNOUF_GUI_Login extends BEGEOT_BUNOUF_CustomJFrame {
    ...
    public BEGEOT_BUNOUF_GUI_Login() {
    ...
    private void createUIComponents() {
        fieldMatricule = new BEGEOT_BUNOUF_CustomJTextField("NUMERIC", false, 8);
        fieldPassword = new BEGEOT_BUNOUF_CustomJTextField("ALL", true, 20);
    }
    ...
    private void loginVerifier() {
        ...
        if (etudiant)
            new BEGEOT_BUNOUF_GUI_USER_Etudiant(Integer.parseInt(fieldMatricule.getText()));
        else if (professeur)
            new BEGEOT_BUNOUF_GUI_USER_Professeur(Integer.parseInt(fieldMatricule.getText()));
        else if (admin)
            new BEGEOT_BUNOUF_GUI_USER_Admin();
