...
import static recherche.BEGEOT_BUNOUF_Recherche.*;
import static recherche.BEGEOT_BUNOUF_RechercheProfesseur.*;
 ...
 * @author Hugues
 */
class BEGEOT_BUNOUF_GUI_USER_Professeur extends BEGEOT_BUNOUF_CustomJFrame
{
     ...
     */
    public BEGEOT_BUNOUF_GUI_USER_Professeur(int matricule)
    {
        ...
        buttonEtudiant.addActionListener(e -> new BEGEOT_BUNOUF_GUI_chercherEtudiant(matricule));
        buttonCours.addActionListener(e -> consulteListe());
        buttonModifier.addActionListener(e ->
        {
            new BEGEOT_BUNOUF_GUI_modifierNote(matricule);
            dispose();
        });
