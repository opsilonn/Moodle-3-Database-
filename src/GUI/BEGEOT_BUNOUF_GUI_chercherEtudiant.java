 ...
 * @author Hugues
 */
public class BEGEOT_BUNOUF_GUI_chercherEtudiant extends BEGEOT_BUNOUF_CustomJFrame {
     ...
     */
    public BEGEOT_BUNOUF_GUI_chercherEtudiant(int matricule) {
    ...
    private void createUIComponents() {
        fieldInput = new BEGEOT_BUNOUF_CustomJTextField("NUMERIC", false, 8);
    }
